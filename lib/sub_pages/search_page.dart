                      ...
                      Column(
                        ...
                        children: [
                          Container(
                              ...
                              child: Text(
                                  "TOP SALES BY", style: ts(Colors.black, 45, true))),
                          Container(
                              margin: const EdgeInsets.only(left: 40),
                              child: Text(
                                  "Best price", style: ts(Colors.black87, 35, false))),
                          Row(
                            children: [
                          ...
                          Container(
                              margin: const EdgeInsets.only(left: 40),
                              child: Text(
                                  "most bought", style: ts(Colors.black87, 35, false))),
                          Row(
                            children: [
